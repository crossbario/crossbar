...
All rights to the Crossbar.io source code remain exclusively with [typedef int GmbH](https://github.com/typedefint/). All [external contributors](https://github.com/crossbario/crossbar/blob/master/legal/contributors.md) need to sign a **contributor assignment agreement (CAA)** when [contributing to the project](https://github.com/crossbario/crossbar/blob/master/CONTRIBUTING.md).
