...
* typedef int as the project maintainer gets full rights to your contribution.
* typedef int assigns you back as many rights as legally possible. This means that you retain the possibility to use your contribution outside of the project.
* If your contribution is added to the project, typedef int agrees to distribute it under the license which applies at the time you submitted your contribution (i.e. AGPL 3.0 at the time of writing).
...
With the assignment, typedef int can sue on behalf of the project.
