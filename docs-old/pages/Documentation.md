...
> This documentation is an open-source community effort sponsored by [typedef int GmbH](https://github.com/typedefint). Should you find errors or if you have suggestions, please file a doc issue [here](https://github.com/crossbario/crossbar/issues/new).
