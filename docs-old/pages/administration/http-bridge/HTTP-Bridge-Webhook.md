...
**`github_token`** | The same secret as you told GitHub when creating the WebHook configuration. When specified, incoming WebHooks will be checked for valid GitHub signatures via the `X-Hub-Signature` header.
