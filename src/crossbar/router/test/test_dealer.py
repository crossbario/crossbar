...
from crossbar.router.session import RouterApplicationSession, RouterSessionFactory
...
class TestDealer(unittest.TestCase):
    ...
    def test_call_cancel(self):
        ...
        dealer.processRegister(
            session, message.Register(1, "com.example.my.proc", "exact", message.Register.INVOKE_SINGLE, 1)
        )
    ...
    def test_call_cancel_two_sessions(self):
        ...
        dealer.processRegister(
            session0, message.Register(1, "com.example.my.proc", "exact", message.Register.INVOKE_SINGLE, 2)
        )
