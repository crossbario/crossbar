    ...
    async def onJoin(self, details):
        ...
        try:
            ...
            for actorType in [ActorType.PROVIDER, ActorType.CONSUMER]:
                ...
                assert 'created' in request_submitted and isinstance(
                ...
                assert ('vaction_oid' in request_submitted and isinstance(request_submitted['vaction_oid'], bytes) and
                        len(request_submitted['vaction_oid']) == 16)
                ...
                assert 'created' in request_verified and isinstance(
