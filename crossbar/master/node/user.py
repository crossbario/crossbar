...
class UserManager(object):
    ...
    def get_organization(self, org_oid, details=None):
        ...
        self.log.info(
            "{klass}.get_organization(org_oid={org_oid}, details={details})",
            org_oid=org_oid,
    ...
    async def create_organization(self, organization, details=None):
        ...
        self.log.info(
            "{klass}.create_organization(organization={organization}, details={details})",
            klass=self.__class__.__name__,
    ...
    def get_user(self, user_id, details=None):
        ...
        self.log.info(
            "{klass}.get_user(user_id={user_id}, details={details})",
            user_id=user_id,
            klass=self.__class__.__name__,
            details=details,
        )
