...
class PersistentCookieStore(CookieStore):
   ...
   def _iter_persisted_json(self):
      for line in self._iter_persisted():
         yield json.loads(line)


   def _cookie_to_file_format(self, cookie):
   ...
   def _init_store(self):
      ...
      for cookie in self._iter_persisted_json():
         id = cookie['id']
         del cookie['id']
   ...
   def create(self):
      ...
      self._cookie_file.write(self._cookie_to_file_format({
   ...
   def setAuth(self, id, authid, authrole, authmethod):
      ...
      if id in self._cookies:
         ...
         for cookie in self._iter_persisted_json():
            ...
            f.write(self._cookie_to_file_format(cookie))

         move(tmp_file_name, self._cookie_file_name)
