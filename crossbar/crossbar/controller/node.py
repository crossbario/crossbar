            ...
            if worker_type == 'router':
               ...
               for realm in worker.get('realms', []):
                  ...
                  for role in realm.get('roles', []):
                     ...
                     yield self._controller.call('crossbar.node.{}.worker.{}.add_router_realm_role'.format(self._node_id, worker_id), realm_id, role_id, role)
                     log.msg("{}: role '{}' added to realm '{}'".format(worker_logname, role_id, realm_id))
