...
crossbar shell unpair node ./test/cf1/.crossbar/key.pub
crossbar shell unpair node ./test/cf2/.crossbar/key.pub
crossbar shell unpair node ./test/cf3/.crossbar/key.pub
