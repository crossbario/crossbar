...
python ../../crossbarfx/network/test/init_blockchain.py --gateway http://localhost:1545

# stop & rm crossbar
crossbarfx stop --cbdir ./.crossbar || true
...
# start crossbar
CROSSBAR_FABRIC_URL= crossbarfx edge start --cbdir ./.crossbar/ &
# docker run --detach --rm --name xbr_node \
#     --net host --env XBR_HDWALLET_SEED -v ${PWD}:/node \
#     crossbario/crossbarfx:latest \
...
if [[ -z $XBR_FULLTESTS ]]; then
    ...
    python ../../crossbarfx/network/test/test_api03_login.py --debug \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --verifications ./.crossbar/.verifications \
    ...
    python ../../crossbarfx/network/test/test_api03_logout.py --debug \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --cskey=e78df30a6ad13502960dddb477a8ff977c37442678753581f147a131efdb67d7 \
        --ethkey=ae9a2e131e9b359b198fa280de53ddbe2247730b881faae7af08e567e58915bd

    python ../../crossbarfx/network/test/test_api04_member.py \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --cskey=42146252e65814b3d82f1f94debcb985862ff1d650ac598f5811917d38d33912 \
        --ethkey=ae9a2e131e9b359b198fa280de53ddbe2247730b881faae7af08e567e58915bd

    python ../../crossbarfx/network/test/test_api05_market.py \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --verifications ./.crossbar/.verifications \
        --cskey=42146252e65814b3d82f1f94debcb985862ff1d650ac598f5811917d38d33912 \
        --ethkey=ae9a2e131e9b359b198fa280de53ddbe2247730b881faae7af08e567e58915bd
    ...
    python ../../crossbarfx/network/test/test_api06_market.py \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --verifications ./.crossbar/.verifications \
        --cskey=0db085a389c1216ad62b88b408e1d830abca9c9f9dad67eb8c8f8734fe7575eb \
        --ethkey=2e114163041d2fb8d45f9251db259a68ee6bdbfd6d10fe1ae87c5c4bcd6ba491

    python ../../crossbarfx/network/test/test_api07_market.py \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --cskey=42146252e65814b3d82f1f94debcb985862ff1d650ac598f5811917d38d33912 \
        --ethkey=ae9a2e131e9b359b198fa280de53ddbe2247730b881faae7af08e567e58915bd

    python ../../crossbarfx/network/test/test_api08_catalog.py \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --verifications ./.crossbar/.verifications \
        --cskey=0db085a389c1216ad62b88b408e1d830abca9c9f9dad67eb8c8f8734fe7575eb \
        --ethkey=2e114163041d2fb8d45f9251db259a68ee6bdbfd6d10fe1ae87c5c4bcd6ba491

    python ../../crossbarfx/network/test/test_api09_catalog.py \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --cskey=0db085a389c1216ad62b88b408e1d830abca9c9f9dad67eb8c8f8734fe7575eb \
        --ethkey=2e114163041d2fb8d45f9251db259a68ee6bdbfd6d10fe1ae87c5c4bcd6ba491

    python ../../crossbarfx/network/test/test_api10_api.py \
        --url ws://localhost:8080/ws --realm xbrnetwork \
        --verifications ./.crossbar/.verifications \
        --cskey=0db085a389c1216ad62b88b408e1d830abca9c9f9dad67eb8c8f8734fe7575eb \
        --ethkey=2e114163041d2fb8d45f9251db259a68ee6bdbfd6d10fe1ae87c5c4bcd6ba491
...
# stop crossbar
crossbarfx stop --cbdir ./.crossbar
