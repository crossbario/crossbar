...
crossbarfx shell --realm default add routercluster-workergroup cluster2 mygroup2 --config '{}'
crossbarfx shell --realm default add routercluster-workergroup cluster2 mygroup3 --config '{}'
...
crossbarfx shell --realm default create role myrole2 --config='{}'
crossbarfx shell --realm default add role-permission myrole2 "" \
    --config='{"match": "prefix", "allow_call": true, "allow_register": true, "allow_publish": true, "allow_subscribe": true, "disclose_caller": true, "disclose_publisher": true, "cache": true}'
...
crossbarfx shell --realm default create arealm myrealm2 --config='{"enable_meta_api": true, "bridge_meta_api": true}'
crossbarfx shell --realm default add arealm-role myrealm2 myrole2 --config='{"authmethod": "anonymous"}'
crossbarfx shell --realm default start arealm myrealm2 cluster2 mygroup2 cluster1

crossbarfx shell --realm default create arealm myrealm3 --config='{"enable_meta_api": true, "bridge_meta_api": true}'
...
crossbarfx shell --realm default create arealm myrealm4 --config='{"enable_meta_api": true, "bridge_meta_api": true}'
...
# FIXME
crossbarfx shell --realm default add principal myrealm4 user1 --config='{"authrole": "myrole2"}'
crossbarfx shell --realm default add principal-credential myrealm4 user1 --config='{"authmethod": "ticket", "secret": "secret123"}'

crossbarfx shell --realm default list principals myrealm4
crossbarfx shell --realm default list principals myrealm4 --names
crossbarfx shell --realm default show principal myrealm4 user1

crossbarfx shell --realm default list principal-credentials myrealm4 user1
