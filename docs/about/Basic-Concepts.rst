...
We recommend getting started using Docker (see `Getting
Started <Getting%20Started>`__), but Crossbar.io runs across a wide
range of devices, some of which we provide `installation
instructions </docs/Installation>`__ for.
